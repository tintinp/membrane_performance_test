defmodule MembranePerformanceTest.Membrane.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule MembranePerformanceTestWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :membrane_performance_test
  ...
  use PromEx, otp_app: :membrane_performance_test
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      # {Plugins.Phoenix, router: MembranePerformanceTestWeb.Router, endpoint: MembranePerformanceTestWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
      ...
      # MembranePerformanceTest.Membrane.Users.PromExPlugin
      MembranePerformanceTest.Monitoring.PromExPlugin
    ]
  end
